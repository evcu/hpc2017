...
******************************************************************************/
//EXPLANATION some timings are ridicolously fast, I read a bit about this and it says there are two types of imlementattion of send/recv.
// Eager and Rendezvous. Which one to use is usually determined by the data size. And sometimes it may cause problems. I added barrier to 
// fix the problem.
#include "mpi.h"
#include <stdio.h>
#include <stdlib.h>
...
//FIX If more than 2 process, they call barrier
else{
  while(1)     MPI_Barrier(MPI_COMM_WORLD);
}
